 ...
 * fetch client against the auth gateway (AUTH_GATEWAY_URL).
 *
...
const AUTH_REST_URL = process.env.AUTH_GATEWAY_URL;
const AUTH_SERVICE_KEY = process.env.AUTH_GATEWAY_SERVICE_KEY;
const AUTH_ANON_KEY = process.env.AUTH_GATEWAY_ANON_KEY;
...
// while using no `@gateway/*` SDK (thin fetch client, see db/restFetch.js).
