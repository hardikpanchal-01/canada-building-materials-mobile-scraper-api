 ...
 * @desc    Send push notification to device(s) (uses main Postgres)
 * @access  Private
 */
 ...
 * @desc    Send push notification via FCM (uses notification Postgres)
 * @access  Private
 */
 ...
 * @desc    Get notification history for authenticated user (uses notification Postgres)
 * @access  Private
 */
