  ...
  try {
    await executeDirectSQL(
      `INSERT INTO public.notification_queue
         (queue_uuid, channel_code, user_id, event_code, event_name, entity_type, entity_id,
          subject, body, priority, status, tenant_id, order_code, order_date)
       VALUES ($1, 'push', $2, $3, $4, $5, $6, $7, $8, 1, 'sent', $9, $10, $11)`,
      [
        crypto.randomUUID(),
        userId,
        eventCode,
