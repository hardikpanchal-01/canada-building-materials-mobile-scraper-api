...
/**
 * Login with email and password using the auth store
...
async function loginWithEmail(email, password, deviceInfo = null) {
  try {
    ...
    // ---------------------------------------------------------------
    // Authenticate with the auth store
    // ---------------------------------------------------------------
...
/**
 * Login with phone and password using the auth store
...
async function loginWithPhone(phone, password, deviceInfo = null) {
  try {
    ...
    // ---------------------------------------------------------------
    // Authenticate with the auth store using phone
    // ---------------------------------------------------------------
    const { data, error } = await db.auth.signInWithPassword({
      phone,
      password
